...
\rfoot{Cadenas de Markov 2025-I}
...
\fancypagestyle{firstpage}{
  ...
  \chead{
      \begin{tabular}{|ccc|r|}
           ...
           &  &  & \\
           & {\large Cadenas de Markov 2025-I} &  & \textbf{Docente:} \\
           &  &  & Freddy Hernandez \\
           & {\Large Path Sampling Telescópico} &  & fohernandezr@unal.edu.co \\
           & {\Large para q-Coloraciones} &  &  \\
           \hline
      \end{tabular}\\
  }
}
...
\lstdefinestyle{pythonstyle}{
    ...
    captionpos=b,
    escapeinside={(*@}{@*)},
    morekeywords={self,True,False,None,return,def,class,if,else,elif,for,while,with,as,import,from}
}
